...
require "mail.php";
	...
	function save_password($password){
		...
		$query = "update aregistration set password = '$password' where email = '$email' limit 1";
		mysqli_query($con,$query);
	...
	function valid_email($email){
		...
		$query = "select * from aregistration where email = '$email' limit 1";		
				...
				case 'enter_email':
					...
					?>
						<form method="post" action="forgot.php?mode=enter_email"> 
							...
							<br><br>
							<div><a href="./aregistratio">Login</a></div>
						</form>
					<?php				
					break;
				...
				case 'enter_code':
					...
					?>
						<form method="post" action="forgot.php?mode=enter_code"> 
							...
							<br><br>
							<div><a href="admin_login.php">Login</a></div>
						</form>
					<?php
					break;

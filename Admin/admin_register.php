...
<html lang="en">
    ...
    <body>
        ...
        <h2 class="heading">ADMIN REGISTRATION INTERFACE</h2>

        <form id="create-account-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" autocomplete="on">
